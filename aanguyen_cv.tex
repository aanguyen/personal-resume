...
\begin{document}
	...
	\begin{main}%
		...
		\section{Projects}
			...
			\vspace{0.65cm}%
		%\section{something}
		%	another option is to put volunteer here, would that make sense tho? feels like it should be after experience but obv projects is more important/relevant
	\end{main}%
\end{document}

%%%
%To-Do
%Make projects more feature-oriented instead of what they do?
%