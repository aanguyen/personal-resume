  ...
  \begin{sidebar}
    \section{SKILLS}
      \subheader{Languages}
        ...
        \iterate{Visual Basic, VDHL}
      \subheader{Technologies}
        \iterate{Android Studio, Git}
        \iterate{Subversion, Firebase, Arduino}
        \iterate{Visual Studio, Jira}
    \section{AWARDS}
  ...
  \begin{main}
    ...
    \section{PROJECTS}
      \begin{entrylist}
        ...
        \rightentry%
          {MongoDB, Node, Vue}%
          {\href{https://github.com/dtong1113/TherapyHelper}{\iconentry{\FAB\symbol{"F09B}}{Therapy Helper}}}%
          {Jan 2017}%
          {DeltaHacks}%
          {\createlist%
            {%
